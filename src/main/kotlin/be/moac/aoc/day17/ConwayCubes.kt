...
//        ConwayCubesPartTwo.partTwo(input)
//    }
//    timed { println("Part one: ${ConwayCubes.partOne(input)}") }
    timed { println("Part two: ${ConwayCubesPartTwo.partTwo(input)}") }
}
...
private fun String.parse(): Space {
...
private typealias Space = Array<Array<BooleanArray>>
...
private fun <R> loop(block: (Int, Int, Int) -> R) =
