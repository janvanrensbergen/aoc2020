...
internal class PasswordsCheckerTest {
    ...
    @Test
    internal fun `that part two will validate fields - invalid examples`() {
        ...
        //When:
        val result = PasswordsChecker.partTwo(input)
    ...
    @Test
    internal fun `that part two will validate fields - valid examples`() {
